...
class Invoice {
     ...
     *
     * @param \PDP\Integration\Model\Sales\Order\Pdf\Items\Invoice $subject
     * @param array $result
     * @return array
     * @SuppressWarnings(PHPMD.UnusedFormalParameter)
     */
    public function afterGetImagesCustomDesign(\PDP\Integration\Model\Sales\Order\Pdf\Items\Invoice $subject, $result)
    {
