...
class Shipment {
     ...
     *
     * @param \PDP\Integration\Model\Sales\Order\Pdf\Items\Shipment $subject
     * @param array $result
     * @return array
     * @SuppressWarnings(PHPMD.UnusedFormalParameter)
     */
    public function afterGetImagesCustomDesign(\PDP\Integration\Model\Sales\Order\Pdf\Items\Shipment $subject, $result)
    {
